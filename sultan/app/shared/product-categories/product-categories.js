      ...
      <ul className="product-categories-list">
        <li>
          ...
          >
            <div className="product-categories-button-background">
              <img
                className="household-chemicals-img"
                src="/household_chemicals.png"
                alt="Бытовая химия"
              />
            </div>
            <p>Бытовая химия</p>
        ...
        <li>
          ...
          >
            <div className="product-categories-button-background">
              <img
                className="cosmetics-img"
                src="/cosmetics.png"
                alt="Косметика и гигиена"
              />
            </div>
        ...
        <li>
          ...
          >
            <div className="product-categories-button-background">
              <img
                className="mom-and-child-img"
                src="mom_and_child.png"
                alt="Товары для детей и мам"
              />
            </div>
