      ...
      <footer className="footer">
        ...
        <img src="/sultan.svg" alt="Visa" width={150} height={70}/>
          ...
          <div>
            ...
            <br />
            <input type="email" id="subscribe" placeholder="Введите ваш E-mail" className="footer-input" />
        ...
        <div className="footer-section">
          ...
          <ul className="footer-list">
            ...
            <li><a href="/tableware">Посуды</a></li>
          </ul>
        </div>
        ...
        <div className="footer-section">
          ...
          <a href="https://t.me/kot_Shreda" download className="footer-messenger">
            <img src="/Whatsapp_icon.svg" alt="Telegram" className="footer-icon" />
          </a>
      
          <a href="https://t.me/kot_Shreda" download className="footer-messenger">
            <img src="/Telegram_icon.svg" alt="Telegram" className="footer-icon" />
          </a>
            </div>
