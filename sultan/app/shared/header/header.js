        ...
        <header className="header">
            ...
            <div className="header-mobile">
                <div class="header-mobile-1">
                    ...
                    <div className="header-logo-sultan">
                        <a href="/" className="logo-sultan-link">
                            <img src="/logo-sultan.svg" alt="Султан" width={97} height={41} className="logo-sultan" />
                        </a>
                    </div>
                ...
                <div className="header-mobile-2">
                    ...
                    <div className="header-search-form">
                        <form>
                            <input type="text" id="searchInput" placeholder="Поиск" className="header-search-form-input" />
                            <button type="submit" className="header-search-form-button"><img src="/search_icon_mobile.svg" alt="Поиск" width={12} height={12} /></button>
                        </form>
                    </div>
                </div>
                ...
                {popup && (
                        <div className="popup-menu-content">
                            ...
                            <div className="header-order-call">
                                ...
                                />
                                <p className="header-signature">
                                    <a href="tel:77774900091" className="order-call-link">Заказать звонок</a>
                                </p>
                            </div>
